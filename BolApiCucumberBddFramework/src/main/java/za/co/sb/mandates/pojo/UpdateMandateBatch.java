...
public class UpdateMandateBatch {
    ...
    private List<updateBatchInstructionList> mandateInstructionList;
	...
	public List<updateBatchInstructionList> getMandateInstructionList() {
		return mandateInstructionList;
	}
	public void setMandateInstructionList(List<updateBatchInstructionList> mandateInstructionList) {
